    ...
    <div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="d-flex flex-row bd-highlight mb-3">
            <div class="p-2 w-50 bd-highlight">
              <div class="input-group mb-3">
                <span class="input-group-text">Tune Id</span>
                <input type="text" class="form-control" v-model="TuneId"/>
              </div>
              <div class="input-group mb-3">
          ...
          <div>
            <button v-if="TuneId ==0" type="button" v-on:click="createClick"
            class="btn btn-primary">Create（作成）</button>
            <button v-else-if="TuneId !=0" type="button" v-on:click="updateClick"
