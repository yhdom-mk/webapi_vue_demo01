          ...
          <tr>
            ...
            <th>
              <div class="d-flex flex-row">
                ...
                placehoder="Filter"/>
                <button type="button" class="btn btn-light"
                v-on:click="sortResult('AlbumName', true)">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down-square" viewBox="0 0 16 16">
                    <path d="M3.626 6.832A.5.5 0 0 1 4 6h8a.5.5 0 0 1 .374.832l-4 4.5a.5.5 0 0 1-.748 0l-4-4.5z"/>
                    <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm15 0a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2z"/>
                  </svg>
                ...
                <button type="button" class="btn btn-light"
                v-on:click="sortResult('AlbumName', false)">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-up-square" viewBox="0 0 16 16">
                    <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                    <path d="M3.544 10.705A.5.5 0 0 0 4 11h8a.5.5 0 0 0 .374-.832l-4-4.5a.5.5 0 0 0-.748 0l-4 4.5a.5.5 0 0 0-.082.537z"/>
                  </svg>
        ...
        <tbody>
          <tr v-for="abm in albums">
            ...
            <td>
              ...
              <button type="button"
                class="btn btn-light mr-1"
                v-on:click="deleteClick(abm.AlbumId)">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" v-model="AlbumName"></input>
          </div>
  ...
  methods: {
    refreshData() {
      ...
      .then((response) => {
        ...
        this.albumsWithoutFilter = response.data;
      });
    },
    ...
    editClick(abm) {
      ...
      this.AlbumId =abm.AlbumId;
      this.AlbumName =abm.AlbumName;
    },
    ...
    FilterFn() {
      ...
      this.albums =this.albumsWithoutFilter.filter(
        function(el) {
    ...
    sortResult(prop, asc) {
      this.albums =this.albumsWithoutFilter.sort(function(a,b) {
        if(asc) {
