const tune = {
          ...
          <div class="d-flex flex-row bd-highlight mb-3">
            <div class="p-2 w-50 bd-highlight">
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" v-model="TuneName"></input>
              </div>
              <div class="input-group mb-3">
                <span class="input-group-text">Album</span>
                <select class="form-select" v-model="Album">
                  <option v-for="abm in albums">
                    {/* {{abm.AlbumName}} */}
                  </option>
                </select>
              </div>
              <div class="input-group mb-3">
                ...
                <input type="date" class="form-control" v-model="DateOfJoining"></input>
              </div>
            </div>
            <div class="p-2 w-50 bd-highlight">
              <img width="250px" height="250px"
              v-bind:src="PhotoPath+PhotoFileName"/>
              <input class="m-2" type="file" v-on:change="imageUpload"></input>
  ...
  methods: {
    ...
    editClick(tun) {
      this.modalTitle ="Edit Tune";
      this.TuneId =tun.TuneId;
      this.TuneName =tun.TuneName;
      this.Album =tun.Album,
      this.DateOfJoining =tun.DateOfJoining,
      this.PhotoFileName =tun.PhotoFileName
    },
    createClick() {
